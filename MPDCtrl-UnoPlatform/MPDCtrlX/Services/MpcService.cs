    ...
    */
    ...
    private Task<bool> ParseStatus(string result)
    {
        ...
        catch (Exception ex)
        {
            ...
            App.DispatcherQueue.TryEnqueue(DispatcherQueuePriority.Normal, () =>
            {
                (Application.Current as App)?.AppendErrorLog("Exception@MPC@ParseStatus", ex.Message);
            });
    ...
    private Task<bool> ParsePlaylists(string result)
    {
        ...
        catch (Exception e)
        {
            ...
            App.DispatcherQueue.TryEnqueue(DispatcherQueuePriority.Normal, () => { (Application.Current as App)?.AppendErrorLog("Exception@MPC@ParsePlaylists", e.Message); });
    ...
    private Task<bool> ParseListAll(string result)
    {
        ...
        catch (Exception e)
        {
            ...
            App.DispatcherQueue.TryEnqueue(DispatcherQueuePriority.Normal, () =>{ (Application.Current as App)?.AppendErrorLog("Exception@MPC@ParseListAll", e.Message); });
    ...
    private Task<bool> ParseSearchResult(string result)
    {
        ...
        */
        ...
        catch (Exception ex)
        {
            ...
            App.DispatcherQueue.TryEnqueue(DispatcherQueuePriority.Normal, () => { (Application.Current as App)?.AppendErrorLog("Exception@MPC@ParseSearchResult", ex.Message); });
    ...
    private ObservableCollection<SongInfo> ParsePlaylistSongsResult(string result)
    {
        ...
        */
        ...
        catch (Exception ex)
        {
            ...
            App.DispatcherQueue.TryEnqueue(DispatcherQueuePriority.Normal, () => { (Application.Current as App)?.AppendErrorLog("Exception@MPC@ParsePlaylistSongsResult", ex.Message); });
            return songList;
        }
