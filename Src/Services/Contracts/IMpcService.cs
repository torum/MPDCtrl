...
public interface IMpcService
{
    ...
    Task<CommandResult> MpdQueryCurrentSong();
    Task<CommandResult> MpdQueryListAll();
    Task<CommandResult> MpdQueryPlaylists();
    Task<CommandPlaylistResult> MpdQueryPlaylistSongs(string playlistName);
    Task<CommandResult> MpdQueryStatus();
    ...
    Task<CommandSearchResult> MpdSearch(string queryTag, string queryShiki, string queryValue);
